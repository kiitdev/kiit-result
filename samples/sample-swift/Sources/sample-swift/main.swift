...
// Generics require AnyObject (Swift Int/String are value types), so use boxed KotlinInt/NSString.
...
// Note: flatMap isn't usable from Swift for constructing new results. Its bridged closure type
