...
mavenPublishing {
    ...
    pom {
        ...
        scm {
            url = "https://github.com/kiitdev/kiit-result"
            connection = "scm:git:git://github.com/kiitdev/kiit-result.git"
            developerConnection = "scm:git:ssh://git@github.com/kiitdev/kiit-result.git"
        }
    }
}
